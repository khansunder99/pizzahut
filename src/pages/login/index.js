  ...
  return (
    <>
      ...
      >
        ...
        <div className="flex mt-8 flex items-center 2xl:w-full xl:w-full lg:w-full md:w-full sm:w-3/4 w-11/12">
          <button
            onClick={() => router.push("/")}
          ...
          >
            <svg
              ...
              stroke-width="2.8"
              stroke="currentColor"
              className="w-6 h-6 2xl:ml-32 xl:ml-28 md:ml-24 md:ml-20 ml-0 stroke-black"
            >
              <path
          ...
          <div className="2xl:w-1/2 xl:w-1/2 lg:w-1/2 md:w-1/2 sm:w-2/3 w-11/12 flex items-end flex-col">
            ...
            <div className="w-full mt-1">
              <div className="flex flex-row">
                ...
                <p className="2xl:text-sm xl:text-sm lg:text-sm md:text-sm sm:text-sm text-xs  text-slate-900 underline underline-offset-2 ml-1 cursor-pointer">
            ...
            <p className="2xl:text-sm xl:text-sm lg:text-sm md:text-sm sm:text-sm text-xs  text-slate-900 flex underline underline-offset-2 mt-1 cursor-pointer">
              Нууц үг сэргээх
            </p>
