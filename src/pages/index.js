    ...
    <div className="w-full h-full">
      <div className="fixed w-full h-[57px] bg-white flex items-center justify-between px-4">
        ...
        <div className="md:flex flex items-center gap-4">
          ...
          <a className="hover:text-red-500 cursor-pointer hover:underline hover:underline-offset-1 text-gray-400 text-sm tracking-normal">
            Нэвтрэх
          </a>
          <p  className="cursor-pointer text-gray-400 text-sm tracking-normal">/</p>
          <a className="hover:text-red-500 cursor-pointer hover:underline hover:underline-offset-1 text-gray-400 text-sm tracking-normal">
            Бүртгүүлэх
          </a>
          </div>
      ...
      <div className="flex justify-center items-center flex-col md:-translate-y-24">
        ...
        <button className="bg-green-700 rounded-md hover:bg-green-800 w-7/12 md:w-7/12 h-12 mt-8  items-center flex justify-center text-white">
          Менюг харах
        </button>
      </div>
    </div>
