...
export default function Home() {
  return (
    ...
    >
          ...
          <div className=" w-full mt-1">
            ...
            <div className="flex flex-row">
              ...
              <p className="text-sm 2xl:text-sm xl:text-sm lg:text-sm md:text-sm sm:text-sm text-xs ml-2 mt-3 text-slate-900 flex flex-row">
                Зөвшөөрөх Пицца Хат
                <p className="text-green-700 underline underline-offset-2 ml-1">
                  Үйлчилгээний нөхцөл
                </p>
              </p>
            </div>
      ...
      <img
        className="w-16 fixed mt-[700px] mr-[1330px]"
        src="https://erxes.tavanbogd.mn/gateway/read-file?key=0.12943882451121258SauceOnlyOnWhiteRGB.PNG"
      ></img>
    </div>
  );
}
